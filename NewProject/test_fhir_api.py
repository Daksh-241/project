    ...
    "entry": [
        ...
        },
        {
            "resource": {
                ...
                "status": "final",
                "code": {
                    "coding": [{"system": "http://loinc.org", "code": sample_data["loinc_code"], "display": sample_data["observation_name"]}]
                },
...
response = requests.post("http://127.0.0.1:8000/fhir_resource", json=fhir_bundle)
